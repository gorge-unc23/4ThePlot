...
class AddEventSummaryPage extends StatelessWidget {
	const AddEventSummaryPage({super.key});

	void _handleCreate(BuildContext context, AddEventDraft draft) {
		Navigator.of(context).pushReplacement(
			MaterialPageRoute(
				builder: (context) => const AddEventConfirmationPage(),
			),
		);
					...
					_SectionCard(
						child: Column(
							...
							children: [
								...
								_SummaryRow(label: 'Venue', value: draft.venueName.isEmpty ? 'N/A' : draft.venueName),
								_SummaryRow(label: 'Date & time', value: dateLabel),
								_SummaryRow(label: 'Price', value: priceLabel),
								_SummaryRow(
									label: 'Capacity',
									value: draft.capacityMax == null ? 'Unlimited' : draft.capacityMax.toString(),
								),
							],
						),
					),
				...
				child: Container(
					...
					child: Column(
						...
						children: [
							...
							const SizedBox(height: 8),
							Text(
								'This is a mock confirmation screen.',
